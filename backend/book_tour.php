    ...
    <table class="table">
        ...
        <?php foreach ($paycart as $paycart):
            ...
            <tr>
                ...
                <td><a href="book_tour.php?action=done&name=<?php echo $paycart['name']; ?>&phone=<?php echo $paycart['phone'] ?>&email=<?php echo $paycart['email'] ?>&address=<?php echo $paycart['address'] ?>&day=<?php echo $paycart['trading_day'] ?>" class=" myLink1 " hidden="hidden" onclick="return confirm('Do you want to change the status to done?')" >Done</a></td>
                <td><a href="book_tour.php?action=consulting&name=<?php echo $paycart['name']; ?>&phone=<?php echo $paycart['phone'] ?>&email=<?php echo $paycart['email'] ?>&address=<?php echo $paycart['address'] ?>&day=<?php echo $paycart['trading_day'] ?>" class=" myLink2 " hidden="hidden" onclick="return confirm('Do you want to change the status to consulting?')">Consulting</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
