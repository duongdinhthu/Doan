...
<body>
<div>
    <a href="fpthappy1.php" class="btn btn-outline-primary" style="border-radius: 10px; margin-top: 50px; margin-left: 220px; margin-bottom: 10px">Back</a>
    <div class="container">
        ...
        <table class="table">
            ...
            <?php foreach ($product as $paycart):
                ...
                <tr>
                    ...
                    <td class="td"><a href="update_product1.php?action=update&id=<?php echo $paycart['pid']  ?>&name=<?php echo $paycart['name']  ?>&price=<?php echo $paycart['price']  ?>" >Update product</a></td>
