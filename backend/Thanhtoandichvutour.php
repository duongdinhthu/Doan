...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "insert into book_tour(name_,phone,email,address,pid)values('$name','$phone','$email','$address','301')";
...
<div class="container">
    ...
    <div class="right-column">
        ...
        <p>Adventure Camping in Dau Tieng Lake: Kayak Tour in Ha Long-Discovering Thien Cung Cave</p>
        <p>Departure Date: 03/07/2024</p>
        <p>Available Seats: 15</p>
        <img src="https://ticotravel.com.vn/wp-content/uploads/2022/06/ho-dau-tieng-3.jpg" style="width:500px;height:300px;">
        <table>
            <tr>
                <th>Type</th>
                <th>Price</th>
