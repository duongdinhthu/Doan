...
<div class="text">
    ...
    <h2>DETAIL ESSENTIAL PRODUCT</h2>
    <hr/>
</div>
<div id="card-body">
    ...
    <div class="main-content">
        ...
        <div class="content-section" id="shipping-policy" style="display:none">
            ...
            <div>
                <h3 style="text-align: start">1. Shipping Fee</h3>
                <ul>
                    <li>
            ...
            <div>
                <h3 style="text-align: start">2. Delivery Time</h3>
                <ul>
                    <li>
            ...
            <div>
                <h3 style="text-align: start">3. Shipping Methods</h3>
                <ul>
                    <li>
            ...
            <div>
                <h3 style="text-align: start">4. Returns/Exchanges</h3>
                <ul>
                    <li>
        ...
        <div class="content-section" id="return-warranty" style="display:none">
            ...
            <div>
                <h3 style="text-align: start">1. Returns/Exchanges</h3>
                <ul>
                    <li>
            ...
            <div>
                <h3 style="text-align: start">2. Warranty</h3>
                <ul>
                    <li>
            ...
            <div>
                <h3 style="text-align: start">3. Return & Warranty Conditions</h3>
                <ul>
    ...
    <div class="content-section" id="payment-methods" style="display:none">
        ...
        <div id="creditCard">
            <h3 style="text-align: start">1. Credit Card</h3>
            <ul>
                <li>
        ...
        <div id="payPal">
            <h3 style="text-align: start">2. PayPal</h3>
            <ul>
                <li>
        ...
        <div id="bankTransfer">
            <h3 style="text-align: start">3. Bank Transfer</h3>
            <ul>
                <li>
