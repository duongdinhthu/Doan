                ...
                <div>
                    <form action="" method="post">
                        ...
                        <h5 class="cost">
                            ...
                            <button type="submit" class="buy-button"><a href="Thanhtoandichvutrongoi.php?id=<?php echo $product["pid"]; ?>" style="color: white; text-decoration: none">Contact Us</a></button>
                        </h5>
                    </form>
                </div>
            </div>
